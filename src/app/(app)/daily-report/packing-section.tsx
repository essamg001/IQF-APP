...
export function PackingSection({
  ...
  return (
    <Card className="overflow-x-auto">
      <h2 className="text-sm font-semibold text-slate-900">II) Packing</h2>
      <div className="mt-3">
      ...
      <table className="mt-4 w-full text-left text-xs">
        <thead className="border-b border-slate-200 bg-slate-50 text-slate-500">
          <tr>
            ...
            <th className="px-2 py-2 font-medium">Total Pkgs</th>
            <th className="px-2 py-2 font-medium">Total Ton</th>
          </tr>
        </thead>
        <tbody>
          {lines.map((l) => (
