  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card>
          <h2 className="text-sm font-semibold text-slate-900">Microbiology Approval</h2>
          <p className="mt-1 text-xs text-slate-500">
            Pallets cannot ship until this lot is approved. Severe failures move pallets to waste automatically;
            minor failures offer pallets at a discount.
          </p>
          <form action={updateMicrobiologyAction.bind(null, lot.id)} className="mt-4 space-y-3">
