...
const NAV_SECTIONS: { headerKey?: NavKey; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/daily-report", labelKey: "dailyReport", roles: ["OWNER", "QUALITY", "PRODUCTION", "MAINTENANCE"] },
      ...
      { href: "/equipment-verification", labelKey: "equipmentVerification", roles: ["OWNER", "QUALITY", "PRODUCTION", "MAINTENANCE"] },
