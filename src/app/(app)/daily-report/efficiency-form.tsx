...
export function EfficiencyForm({
  ...
  return (
    <form action={formAction} className="flex flex-wrap items-end gap-2">
      ...
      <FieldGroup label="Expected qty (ton)">
        <Input
      ...
      <FieldGroup label="Actual qty (ton)">
        <Input
